...
void main()
{
  ...
  float diffLightIntensity = max(dot(normal, lightDirection), 0.0);
  vec3 diffuse = diffLightIntensity * vec3(1.0, 1.0, 1.0); 
  ...
  diff = dot(normal, lightDirection) * diffLightIntensity;
  spec = specIntensity;
